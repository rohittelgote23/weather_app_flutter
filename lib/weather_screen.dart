...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  String errorMessage = ''; // Add errorMessage to show errors
  ...
  Future<Map<String, dynamic>> getCurrentWeather() async {
    try {
      ...
      if (data['cod'] != '200') {
        throw "Could not retrieve weather data. Please check the city name or try again later.";
      }
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Search input stays outside the FutureBuilder
            TextField(
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  ...
                  onPressed: () {
                    setState(() {
                      weather = getCurrentWeather();
                      errorMessage = ''; // Clear error on new search
                    });
                  },
                ),
              ),
            ...
            FutureBuilder(
              ...
              builder: (context, snapshot) {
                ...
                for (int i = 0; i < 8; i++) {
                  double windY = data['list'][i]['wind']['speed'].toDouble();
